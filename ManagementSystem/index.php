...
<div class="row">
	<div class="col-md-4 col-md-offset-3">
		...
		<center><h2 style="margin-top:1px;">Area 420 System</h2></center>
			<form class="form-horizontal form-custom-login" action="" method="POST">
			  ...
			  <button type="submit" name="login_btn" class="btn btn-primary pull-right">Login</button>
			</form>
		</div>
	</div>
</div>
